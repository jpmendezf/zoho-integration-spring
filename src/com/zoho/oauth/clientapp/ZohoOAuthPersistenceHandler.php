...
class ZohoOAuthPersistenceHandler implements ZohoOAuthPersistenceInterface
{
	...
	public function getMysqlConnection()
	{
		...
		$mysqli_con = new mysqli(ZohoOAuth::getConfigValue(ZohoOAuthConstants::DATABASE_SOCKET),ZohoOAuth::getConfigValue(ZohoOAuthConstants::DATABASE_USERNAME),
        ZohoOAuth::getConfigValue(ZohoOAuthConstants::DATABASE_PASSWORD), ZohoOAuth::getConfigValue(ZohoOAuthConstants::DATABASE_NAME));
